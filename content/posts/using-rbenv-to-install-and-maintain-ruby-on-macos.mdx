...
4. Restart your shell so that PATH changes take effect. (Opening a new terminal tab will usually do it.). Verify that rbenv is properly set up using this [rbenv-doctor][7] script:
